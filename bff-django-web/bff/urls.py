...
urlpatterns = [
    ...
    path("financial-registers-bff/resumecards", ResumeCardsView.as_view(), name="resume-cards"),
    path("financial-registers-bff/categoryresume", CategoryResumeView.as_view(), name="resume-category"),
    path("financial-registers-bff/mouthresume", MouthResumeView.as_view(), name="resume-month"),
