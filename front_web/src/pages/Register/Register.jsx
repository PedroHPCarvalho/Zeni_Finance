...
export default function Cadastro() {
  ...
  const handleConfirmRegister = async () => {
    ...
    // erro aparece no form automaticamente
  };
      ...
      {showModal && (
        <div className={styles.modal_overlay}>
          <div className={styles.modal_container}>
            <div className={styles.modal_header}><h3>Autorização de Dados</h3></div>
            <div className={styles.modal_content}>
              <h4>Obtenção de Consentimento</h4>
              <p className={styles.modal_desc}>
                Antes do usuário começar a usar o assistente financeiro, será solicitado o consentimento.
              </p>
              ...
              <div className={styles.modal_privacy_box}>
                <p><strong>Privacidade: </strong>Seus dados serão utilizados apenas para análise financeira pessoal e nunca serão compartilhados sem autorização explícita.</p>
              </div>
            </div>
            <div className={styles.modal_footer}>
              <button className={styles.btn_refuse} onClick={() => setShowModal(false)} disabled={loading}>Recusar</button>
              <button className={styles.btn_accept} onClick={handleConfirmRegister} disabled={loading}>
        ...
        <div className={styles.form_container}>
          ...
          <form onSubmit={handlePreSubmit} className={styles.register_form}>
            ...
            <div className={styles.input_group}>
              ...
              <input id="name" type="text" name="name" placeholder="Nome completo" value={formData.name} onChange={handleChange} required />
            </div>

            <div className={styles.input_group}>
              <label htmlFor="email">E-mail</label>
              <input id="email" type="email" name="email" placeholder="E-mail" value={formData.email} onChange={handleChange} required />
            </div>

            <div className={styles.input_group}>
              <label htmlFor="phone">Celular</label>
              <input id="phone" type="tel" name="phone" placeholder="(99) 99999-9999" value={formData.phone} onChange={handlePhoneChange} required />
            </div>

            <div className={styles.row_inputs}>
              <div className={styles.input_group}>
                <label htmlFor="password">Senha</label>
                <input id="password" type="password" name="password" placeholder="Senha" value={formData.password} onChange={handleChange} required />
              </div>

              <div className={styles.input_group}>
                <label htmlFor="password_confirmed">Confirmar senha</label>
                <input id="password_confirmed" type="password" name="password_confirmed" placeholder="Confirmar" value={formData.password_confirmed} onChange={handleChange} required />
              </div>
            </div>
